...
Для IPv4+IPv6 используйте `queryStrategy: "UseIP"`, а не принудительный `UseIPv4`. Сам факт наличия IPv6 проверяется установщиком, но конкретное поведение outbound определяет профиль.
